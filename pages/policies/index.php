...
<article>
    ...
    <img src="/img/privacitybanner.png" alt="Políticas de Privacidade">
    
    <p><strong>A sua privacidade é importante para nós. É política do <em>Absoluta & Bela</em> respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <em>Absoluta & Bela</em>, e outros sites que possuímos e operamos.</strong></p>
    ...
    <h3>Política de Cookies <em>Absoluta & Bela</em></h3>
    ...
    <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o <em>Absoluta & Bela</em> oferece no site e com caráter enunciativo, mas não limitativo:</p>
    <ol type="A">
        ...
        <li>Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do <em>Absoluta & Bela</em>, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
    </ol>

    <h4>Mais informações</h4>
    <p>Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você não tem certeza se precisa ou não, geralmente é mais seguro deixar os cookies ativados, caso interaja com um dos recursos que você usa em nosso site.</p>
    <p><em>Esta política é efetiva a partir de 02 de outubro de 2022 às 14:20.</em></p>
